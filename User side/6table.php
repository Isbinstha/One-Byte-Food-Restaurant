...
$sql_availability = "SELECT TableID, TableName, Availability FROM tables_six"; // Update table name to tables
...
<body>
    ...
    function updateFormFields() {
        ...
        document.getElementById('seats').value = numTables * 6; // Assuming each table has 2 seats

        // Update the total amount displayed
        var totalAmount = numTables * 600; // Assuming each table costs $100
