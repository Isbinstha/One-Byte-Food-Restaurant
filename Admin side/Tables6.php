    ...
    <div class="booking-container">
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if(isset($_POST["TableID"]) && isset($_POST["Availability"])) {
                ...
                $sql = "UPDATE tables_six SET Availability='$newAvailability' WHERE TableID='$tableId'";
        ...
        if(isset($_POST['add_table']) || isset($_POST['delete_table'])) {
            if(isset($_POST['add_table'])) {
                ...
                $check_query = "SELECT * FROM tables_six WHERE TableName='$tableName'";
                ...
                if ($check_result->num_rows > 0) {
                    ...
                    $sql = "INSERT INTO tables_six (TableName, Availability) VALUES ('$tableName', '$availability')";
                    if ($conn->query($sql) === TRUE) {
            ...
            if(isset($_POST['delete_table'])) {
                ...
                $sql = "DELETE FROM tables_six WHERE TableName='$tableName'";
                if ($conn->query($sql) === TRUE) {
